apd2_upgrade_tables = {
  ...
  perma = {
    ...
    perk_1 = { name = "Blending In", desc = "+1 concealment.",
      "player_passive_suspicion_bonus"
    },
    perk_2 = { name = "Second Skin", desc = "15% reduced armor speed penalty.",
      "player_passive_armor_movement_penalty_multiplier"
    },
    perk_3 = { name = "Fast Learner", desc = "45% EXP bonus.",
      "passive_player_xp_multiplier"
    },
    perk_4 = { name = "Whole Bullet", desc = "5% damage bonus",
      "weapon_passive_damage_multiplier"
    },
    perk_5 = { name = "Walk-in Closet Lv1", desc = "Ammo pickup increased by 35%.",
      "player_pick_up_ammo_multiplier"
    },
    perk_6 = { name = "Helmet Popping", desc = "25% headshot damage bonus.",
      "weapon_passive_headshot_damage_multiplier"
    },
    perk_7 = { name = "Triage", desc = "20% faster doctor bag interactions.",
      "passive_doctor_bag_interaction_speed_multiplier"
    },
    perk_8 = { name = "Walk-in Closet Lv2", desc = "Ammo pickup increased by 75%.",
      "player_pick_up_ammo_multiplier_2"
    },
    skill_1 = { name = "Cat Burglar", desc = "Fall damage inflicts armor damage.",
      "player_fall_health_damage_multiplier"
    },
    skill_2 = { name = "Stun Resistance", desc = "75% flashbang resistance.",
      "player_flashbang_multiplier_2"
    },
    skill_3 = { name = "Cleaner", desc = "Can bag bodies.",
      "player_corpse_dispose", "player_extra_corpse_dispose_amount"
    },
    skill_4 = { name = "Dominator", desc = "Can intimidate non-special enemies.",
      "player_intimidate_enemies"
    },
    skill_5 = { name = "Drop Cloth", desc = "Enemy death alert range reduced by 95%.",
      "player_silent_kill"
    },
    skill_6 = { name = "Toolkit", desc = "Repair drills and saws 25% faster.",
      "player_drill_fix_interaction_speed_multiplier"
    },
    skill_7 = { name = "Handyman", desc = "100% faster deployable interactions.",
      "deploy_interact_faster_1"
    },
    skill_8 = { name = "Die Hard", desc = "50% damage reduction while interacting.",
  ...
  perks = {
    ...
    crook_lbv_dodge_1 = { name = "LBV Composure Lv1", desc = "+5% dodge chance (lightweight ballistic vest).",
                          upg_type = "stat", item_req = "body_armor1", cancel = "crook_lbv_dodge_2,crook_lbv_dodge_3",
      "player_level_2_dodge_addend_1"
    },
    crook_lbv_dodge_2 = { name = "LBV Composure Lv2", desc = "+15% dodge chance (lightweight ballistic vest).",
                          upg_type = "stat", item_req = "body_armor1", cancel = "crook_lbv_dodge_1,crook_lbv_dodge_3",
    ...
    crook_lbv_dodge_3 = { name = "LBV Composure Lv3", desc = "+25% dodge chance (lightweight ballistic vest).",
                          upg_type = "stat", item_req = "body_armor1", cancel = "crook_lbv_dodge_1,crook_lbv_dodge_2",
    ...
    crook_lbv_armour_1 = { name = "LBV Impact Lv1", desc = "20% armor bonus (lightweight ballistic vest).",
                           upg_type = "stat", item_req = "body_armor1", cancel = "crook_lbv_armour_2,crook_lbv_armour_3",
      "player_level_2_armor_multiplier_1"
    },
    crook_lbv_armour_2 = { name = "LBV Impact Lv2", desc = "40% armor bonus (lightweight ballistic vest).",
                           upg_type = "stat", item_req = "body_armor1", cancel = "crook_lbv_armour_1,crook_lbv_armour_3",
      "player_level_2_armor_multiplier_2"
    },
    crook_lbv_armour_3 = { name = "LBV Impact Lv3", desc = "65% armor bonus (lightweight ballistic vest).",
                           upg_type = "stat", item_req = "body_armor1", cancel = "crook_lbv_armour_1,crook_lbv_armour_2",
    ...
    crook_hbv_dodge_1 = { name = "HBV Composure Lv1", desc = "+5% dodge chance (heavy ballistic vest).",
                          upg_type = "stat", item_req = "body_armor3",
    ...
    burglar_prio_2 = { name = "INVALID", desc = "Target priority reduced by 15% while crouching and stationary.",
                       upg_type = "stat", cancel = "burglar_prio_1,burglar_prio_3",
    ...
    burglar_prio_3 = { name = "INVALID", desc = "Target priority reduced by 20% while crouching and stationary.",
                       upg_type = "stat", cancel = "burglar_prio_1,burglar_prio_2",
    ...
    infil_single_dog_1 = { name = "INVALID", desc = "8% damage reduction when an enemy is within 18m.",
                           upg_type = "ability", cancel = "infil_single_dog_2,infil_single_dog_3",
      "player_damage_dampener_close_contact_1"
    },
    infil_single_dog_2 = { name = "INVALID", desc = "16% damage reduction when an enemy is within 18m.",
                           upg_type = "ability", cancel = "infil_single_dog_1,infil_single_dog_3",
    ...
    infil_single_dog_3 = { name = "INVALID", desc = "24% damage reduction when an enemy is within 18m.",
                           upg_type = "ability", cancel = "infil_single_dog_1,infil_single_dog_2",
    ...
    grind_hot_1 = { name = "INVALID", desc = "+1 health every 0.3s for 3s on damage dealt (1.5s cooldown, req. suit/lightweight ballistic vest).",
                    upg_type = "ability", cancel = "grind_hot_2,grind_hot_3,grind_hot_4"
    ...
    grind_hot_2 = { name = "INVALID", desc = "+2 health every 0.3s for 3s on damage dealt (1.5s cooldown, req. suit/lightweight ballistic vest).",
                    upg_type = "ability", cancel = "grind_hot_1,grind_hot_3,grind_hot_4"
    ...
    grind_hot_3 = { name = "INVALID", desc = "+3 health every 0.3s for 3s on damage dealt (1.5s cooldown, req. suit/lightweight ballistic vest).",
                    upg_type = "ability", cancel = "grind_hot_1,grind_hot_2,grind_hot_4"
    ...
    grind_hot_4 = { name = "INVALID", desc = "+4 health every 0.3s for 3s on damage dealt (1.5s cooldown, req. suit/lightweight ballistic vest).",
                    upg_type = "ability", cancel = "grind_hot_1,grind_hot_2,grind_hot_3"
    ...
    yakuza_recovery_1 = { name = "INVALID", desc = "Armor recovery scales with health lost (up to 20% faster).",
                          upg_type = "ability", cancel = "yakuza_recovery_2,yakuza_recovery_3"
    ...
    yakuza_recovery_2 = { name = "INVALID", desc = "Armor recovery scales with health lost (up to 40% faster).",
                          upg_type = "ability", cancel = "yakuza_recovery_1,yakuza_recovery_3"
    ...
    yakuza_recovery_3 = { name = "INVALID", desc = "Armor recovery scales with health lost (up to 60% faster).",
                          upg_type = "ability", cancel = "yakuza_recovery_1,yakuza_recovery_2"
    ...
    expres_1 = { name = "Break Lv1", desc = "Store 4 health per kill that is consumed on armor recovery.",
                 upg_type = "ability", cancel = "expres_2,expres_3"
    ...
    expres_2 = { name = "Break Lv2", desc = "Store 8 health per kill that is consumed on armor recovery.",
                 upg_type = "ability", cancel = "expres_1,expres_3"
    ...
    expres_3 = { name = "Break Lv3", desc = "Store 12 health per kill that is consumed on armor recovery.",
                 upg_type = "ability", cancel = "expres_1,expres_2"
    ...
    stoic_armor_convert = { name = "Unmoved", desc = "Armor is converted into health.",
                            upg_type = "stat", upg_req = "perks-stoic_base,perks-grind_hot_1,perks-grind_hot_2,perks-grind_hot_3,perks-grind_hot_4," ..
                            "perks-gambler_heal_1,perks-gambler_heal_2,perks-gambler_heal_3,perks-muscle_regen,perks-biker_base,perks-h3h3_base,perks-socio_heal," ..
    ...
    stoic_negate = { name = "", desc = "Lingering damage from 'Virtue' is negated after not taking damage for 4s.",
                     upg_type = "stat", upg_req = "perks-stoic_base",
    ...
    leech_duration = { name = "", desc = "Leech ampule lasts 10 seconds.",
