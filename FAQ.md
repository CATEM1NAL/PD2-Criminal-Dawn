...
There are a few dependencies which BLT will prompt you to install after launching the game with
Criminal Dawn. Download them, restart the game, and you should be good to go. You'll know if the
mod is working because you should have a fresh save file and the main menu will be different.
